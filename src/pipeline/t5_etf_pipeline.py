...
class T5ETFAdvisorPipeline:
    ...
    def run(self):
        ...
        fine_tuned_model = T5ForConditionalGeneration.from_pretrained(self.output_dir)
...
def main():
    ...
    pipeline = T5ETFAdvisorPipeline(model_name, etf_dataset, test_prompts, output_dir, detailed=detailed)
    pipeline.run()
